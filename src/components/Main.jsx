...
const Main = () => {
  ...
  return (
    <div id="main" className="w-full">
      ...
      <div className="z-100 homeText w-full h-screen absolute top-0 left-0 ">
        <div className="flex flex-col justify-start items-end h-screen mt-[20rem] md:mt-0 md:pt-[20rem] mx-5 md:mr-[5rem]">
          <h1 className="text-lg md:text-[2.5rem] font-mono mr-3">
            My name is Bright
          </h1>
          ...
          <div className="flex  md:h-auto md:items-end md:mt-5 mt-[1rem]">
            <a
              href="https://twitter.com/babaspace_"
              className="m-2"
              target="_blank"
            >
              <FaTwitter
            ...
            <a
              href="https://linkedin.com/in/bright-londa"
              className="m-2"
              target="_blank"
            >
              <FaLinkedinIn
            ...
            <a
              href="https://instagram.com/babaspace_"
              className="m-2"
              target="_blank"
            >
              <FaInstagram
